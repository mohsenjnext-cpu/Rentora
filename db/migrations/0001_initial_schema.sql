-- Migration 0001: original Rentora D1 schema baseline
-- This is the historical pre-0002 schema reconstructed from commit 14adf3a.
-- Do not edit after adoption. Existing production databases must NOT apply this
-- migration blindly; first reconcile their d1_migrations ledger.
